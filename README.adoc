...
:experimental:
:url-github: https://github.com/hyperpolymath/zotero-nsai
:url-gitlab: https://gitlab.com/hyperpolymath/zotero-nsai
:url-bitbucket: https://bitbucket.org/hyperpolymath/zotero-nsai
:url-codeberg: https://codeberg.org/hyperpolymath/zotero-nsai

Zotero NSAI content detection integration
...
zotero-nsai is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
